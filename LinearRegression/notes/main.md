...
\frac{1}{N}\sum_{i=1}^{N} y_{i} \\ \end{aligned} $${#eq:LS}
...
$$ y=m_1 d + m_2 w + m_3 a +b $${#eq:multivariate}
...
$\hat{Y}$ for $Y$ is $$ \hat{Y} = XD^{-1}X^{\intercal}Y.
$${#eq:projection}
...
$$ M_{0} = D_{0}^{-1}X_{0}^{\intercal}Y.  $$ The $b$ value we are
