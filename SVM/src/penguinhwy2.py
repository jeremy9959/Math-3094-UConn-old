...
f.line(x,line(x,400-adelie_b),line_width=2,legend_label='y=250x{}'.format(400-adelie_b),color='blue')
f.line(x,line(x,400-gentoo_b),line_width=2,legend_label='y=250x+{}'.format(400-gentoo_b),color='green')
adelie_bs =  margin(adelie['Culmen Depth (mm)'],adelie['Body Mass (g)'])
gentoo_bs =  margin(gentoo['Culmen Depth (mm)'],gentoo['Body Mass (g)'])
for b in adelie_bs:
    f.line(x,line(x,400-b),line_width=2,color='blue',alpha=.2)
    
for b in gentoo_bs:
    f.line(x,line(x,400-b),line_width=2,color='green',alpha=.2)
